...
function createIllustratorPrompt(style, rules) {
...
const standardNegativePrompt = "watermark, logo, signature, UI, subtitles, captions, malformed hands, extra limbs, blurry, low quality";
const textPositiveNegativePrompt = "watermark, logo, signature, UI chrome, unreadable text, broken lettering, malformed speech bubbles, blurry, low quality";
    ...
    promptTemplates: [
        {
            ...
            promptTemplate: createIllustratorPrompt("colored comic page, 2-6 panels, cinematic panel flow, expressive speech bubbles, captions, and SFX lettering", `Build the prompt as a complete comic page. Include panel count, panel composition, camera framing, mood, lighting, and action flow.
...
Use the negativePrompt: ${textPositiveNegativePrompt}.`),
        },
        {
            ...
            promptTemplate: createIllustratorPrompt("colored manga, dynamic panel-inspired composition, cell shading, flat color, screentone texture, manga speech bubbles and SFX", `Build the prompt as a vivid colored manga illustration or page beat. Include expressive poses, panel-like staging, speed lines, impact frames, screentones, and dramatic lighting.
...
Use the negativePrompt: ${textPositiveNegativePrompt}.`),
        },
        {
            ...
            promptTemplate: createIllustratorPrompt("black-and-white manga page, inked line art, screentones, heavy blacks, speed lines, speech bubbles, and hand-lettered SFX", `Build the prompt as a B&W manga beat with strong line weight, screentone shading, dramatic shadows, panel language, and crisp silhouettes.
...
Use the negativePrompt: ${textPositiveNegativePrompt}, color painting, full-color render.`),
        },
        {
            ...
            promptTemplate: createIllustratorPrompt("polished environment background, establishing shot, visual novel/game background quality", `Generate a background-only prompt for the current important location or atmosphere. Focus on architecture, nature, props, weather, lighting, time of day, mood, and readable spatial layout.
...
Use the negativePrompt: ${standardNegativePrompt}, people, character, portrait, crowd.`),
        },
        {
            ...
            promptTemplate: createIllustratorPrompt("in-character selfie, casual portrait, phone camera framing, intimate social snapshot", `Generate a portrait/selfie prompt for the character who would naturally take or send it in the latest moment. Include camera angle, expression, pose, outfit, environment hints, lighting, and phone/selfie framing when appropriate.
