...
assert(manifest.version === "1.4.10", "manifest version is 1.4.10");
assert(manifest.engine?.min === "2.4.6" && manifest.engine?.maxExclusive === "2.4.7", "manifest matches the bridge-supported Engine release");
...
assert(!bundledClient.includes("bridgeSession.ui.register"), "native capability host owns settings mounting");
