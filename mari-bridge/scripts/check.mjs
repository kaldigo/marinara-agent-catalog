...
assert.equal(globalThis[clientSymbol].implementationVersion, "1.2.0");
...
assert.match(preparedOverlayRuntime, /implementationVersion: "1\.2\.0"/u);
...
assert.equal(rebuiltServerOverlay.bridgeVersion, "1.2.0");
