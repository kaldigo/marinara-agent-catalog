...
assert(client.includes('./assets/bridge/message-actions.js'), "client imports packaged message-action bridge");
assert(client.includes('./assets/bridge/commands.js'), "client imports packaged command bridge");
