...
export const GAME_VIDEO_BUILT_IN_PROMPT_TEMPLATES = [
    {
        ...
        description: "Default Game Mode video prompt for animating a saved scene or storyboard keyframe from its first-frame image.",
        promptTemplate: GAME_VIDEO_PROMPT_TEMPLATE,
    },
    {
        id: ANIME_GAME_VIDEO_PROMPT_TEMPLATE_ID,
        name: "Anime Game Video",
        description: "Animates a generated first frame as a continuous anime shot while preserving characters and composition.",
