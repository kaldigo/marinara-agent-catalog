...
function rankedAchievements(groupId, title, descriptionForTarget, icon, metric, category) {
...
export const ACHIEVEMENT_DEFINITIONS = [
    ...
    ...rankedAchievements("who_needs_irl_friends", "Who Needs IRL Friends", (target) => `Created ${target} Conversation chats.`, "conversation", "conversationChats", "creation"),
    ...rankedAchievements("they_feel_real_to_me", "They Feel Real To Me", (target) => `Created ${target} Roleplay chats.`, "roleplay", "roleplayChats", "creation"),
    ...rankedAchievements("i_have_no_other_hobbies", "I Have No Other Hobbies", (target) => `Created ${target} Game mode chats.`, "game", "gameChats", "creation"),
    ...rankedAchievements("hoarder", "Hoarder", (target) => `Collected ${target} Characters.`, "character", "characters", "collection"),
    ...rankedAchievements("the_worlds_a_stage", "The World's A Stage", (target) => `Collected ${target} Lorebooks.`, "lorebook", "lorebooks", "collection"),
...
export const ACHIEVEMENT_DIRECT_EVENT_IDS = {
