...
assert(manifest.version === "1.0.8", "manifest version is 1.0.8");
assert(manifest.engine?.min === "2.4.4", "manifest engine min matches Mari Bridge");
assert(manifest.engine?.maxExclusive === "2.4.5", "manifest stops before an unpatched Engine release");
...
assert(client.includes('PACKAGE_VERSION = "1.0.8"'), "client package version matches manifest");
