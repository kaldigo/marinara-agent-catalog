...
export const DEFAULT_TRANSLATION_SYSTEM_PROMPT = "You are a translator. Translate the given text accurately into {{targetLanguage}}, preserving formatting, markdown, and any special characters like *asterisks* for actions. Output ONLY the translated text, nothing else -- no explanations, no extra commentary.";
/** Resolve the documented language placeholder in a custom translation prompt. */
export function resolveTranslationSystemPrompt(prompt, targetLanguage) {
