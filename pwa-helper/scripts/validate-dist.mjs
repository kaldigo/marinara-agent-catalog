...
assert(client.includes("`${PACKAGE_ID}:native-generation`"), "client has native generation wake lease");
assert(client.includes("marinara:generation-complete"), "client listens for generation complete");
assert(client.includes("marinara:generation-error"), "client listens for generation error");
assert(client.includes("mari-chat-send-btn"), "client includes Marinara send button detection");
