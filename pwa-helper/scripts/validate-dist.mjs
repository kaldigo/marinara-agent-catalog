...
assert(manifest.version === "1.0.9", "manifest version is 1.0.9");
assert(manifest.engine?.min === "2.4.6", "manifest engine min matches Mari Bridge");
assert(manifest.engine?.maxExclusive === "2.4.7", "manifest stops before an unpatched Engine release");
...
assert(client.includes('PACKAGE_VERSION = "1.0.9"'), "client package version matches manifest");
