...
assert(manifest.version === "1.0.2", "manifest version must be 1.0.2");
...
assert(client.includes('PACKAGE_VERSION = "1.0.2"'), "client package version must match manifest");
assert(client.includes('MARI_BRIDGE_VERSION = "1.0.1"'), "client bundles bridge runtime 1.0.1");
