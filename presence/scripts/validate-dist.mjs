...
assert(manifest.version === "1.4.5", "manifest version is 1.4.5");
assert(manifest.engine?.min === "2.4.3" && manifest.engine?.maxExclusive === "2.4.4", "manifest matches the bridge-supported Engine release");
