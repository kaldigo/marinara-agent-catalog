...
export const chessMoveToolManifest = {
    name: "chess_move",
    description: "Make your chess move in Standard Algebraic Notation (SAN). Copy EXACTLY one move from the legal-move list " +
...
/** All chess tools. */
export const CHESS_TOOL_MANIFESTS = [chessMoveToolManifest];
