...
const jsByteLimit = (value) => value == null || utf8ByteLength(value) <= MAX_EXTENSION_JS_BYTES;
...
function validateRuntimePayload(value, ctx) {
...
export const updatePersonalExtensionSchema = personalExtensionPayloadSchema
    ...
    if (value.runtime !== undefined)
        validateRuntimePayload(value, ctx);
});
...
export const personalExtensionStoragePatchSchema = z.record(z.string(), z.unknown()).refine((value) => {
    try {
...
//# sourceMappingURL=personal-extension.schema.js.map