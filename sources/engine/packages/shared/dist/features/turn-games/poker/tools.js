...
export const pokerActionToolManifest = {
    name: "poker_action",
    description: "Take your poker action. Pick ONE of the legal actions listed in your instructions " +
    ...
    parameters: {
        ...
        properties: {
            ...
            amount: {
                type: "number",
                description: "For bet: the chips you put in. For raise: the TOTAL amount you raise the street's bet to. Ignored otherwise.",
            },
        },
        required: ["action"],
    },
...
/** All poker tools. */
export const POKER_TOOL_MANIFESTS = [pokerActionToolManifest];
...
export function parsePokerToolCall(name, args) {
