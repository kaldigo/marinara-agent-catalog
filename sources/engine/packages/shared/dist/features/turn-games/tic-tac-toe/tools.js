...
export const ticTacToeMoveToolManifest = {
    ...
    description: "Place your mark on the tic-tac-toe board. Copy EXACTLY one cell index from the legal-move list you were " +
...
export const TIC_TAC_TOE_TOOL_MANIFESTS = [ticTacToeMoveToolManifest];
